...
if __name__ == '__main__':
    ...
    cloudinary.config(
    cloud_name = "do5lofza7",
    api_key = "538823214882461",
    api_secret = "mKt_6ZQifwe_naMDXw05hU1g4q0",
    secure = True
    )

    expansions = 'attachments.media_keys,author_id,referenced_tweets.id.author_id'
    mentions = bot_client.get_users_mentions(1632150906597695488, expansions=expansions, max_results=5, media_fields="variants", since_id=1646872491049066498)
